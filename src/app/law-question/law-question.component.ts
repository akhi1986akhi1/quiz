...
import { LawQuestionService } from '../service/law-question.service';

@Component({
  selector: 'app-law-question',
  templateUrl: './law-question.component.html',
  styleUrls: ['./law-question.component.scss']
})
export class LawQuestionComponent implements OnInit {
  public name: string = '';
  ...
  constructor(private lawQuestionService: LawQuestionService,private router: Router) { }
  ...
  getAllQuestions() {
    this.lawQuestionService.lawQuestionJson().subscribe((res) => {
