...
import { NextLevelQuestionService } from '../service/next-level-question.service';
...
export class NextLevelComponent implements OnInit {
  ...
  constructor(private nextLevelquestionService: NextLevelQuestionService, private router: Router ) {}
  ...
  getAllQuestions() {
    this.nextLevelquestionService.getNextLevelQuestionJson().subscribe((res) => {
