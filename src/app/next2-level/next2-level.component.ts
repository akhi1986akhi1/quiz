...
import { Next2LevelQuestionService } from '../service/next2-level-question.service';

@Component({
  selector: 'app-next2-level',
  templateUrl: './next2-level.component.html',
  styleUrls: ['./next2-level.component.scss']
})
export class Next2LevelComponent implements OnInit {
  ...
  constructor(private next2LevelquestionService: Next2LevelQuestionService, private router: Router ) {}
  ...
  getAllQuestions() {
    this.next2LevelquestionService.getNext2LevelQuestionJson().subscribe((res) => {
