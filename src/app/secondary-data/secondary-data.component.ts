...
import { SecondaryDataService } from '../service/secondary-data.service';

@Component({
  selector: 'app-secondary-data',
  templateUrl: './secondary-data.component.html',
  styleUrls: ['./secondary-data.component.scss']
})
export class SecondaryDataComponent implements OnInit {
  ...
  constructor(private questionService: SecondaryDataService, private router: Router ) {}
  ...
  getAllQuestions() {
    this.questionService.getSecondaryDataJson().subscribe((res) => {
