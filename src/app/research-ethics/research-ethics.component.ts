...
import { ResearchEthicsService } from '../service/research-ethics.service';
...
export class ResearchEthicsComponent implements OnInit {
  ...
  constructor(private researchService: ResearchEthicsService, private router: Router) { }
  ...
  getAllQuestions() {
    this.researchService.researchEthicsJson().subscribe((res) => {
